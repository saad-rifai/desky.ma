  ...
  <div>
    ...
    <div id="add-card" uk-modal>
      <div class="uk-modal-dialog uk-modal-body uk-text-right">
                <button class="uk-modal-close-default " dir="rtl" type="button" uk-close></button>

    <div class="uk-position-cover uk-overlay uk-overlay-default uk-flex uk-flex-center uk-flex-middle">حاليا لاندعم الدفع بالبطاقة البنكية</div>
