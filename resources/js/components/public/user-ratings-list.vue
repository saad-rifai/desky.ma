...
<div>
    <div id="div-with-loading">
        ...
        <button
            v-if="
                Allresponse.next_page_url && Allresponse.next_page_url != null
            "
    ...
    methods: {
        ...
        ShowMore(){
          ...
          if(this.Allresponse.next_page_url != null){
            axios
                .get("/ajax/public/request/ae/ratings?ac=" + this.ac+"&page="+(parseInt(this.Allresponse.current_page) + 1))
                .then(response => {
                    this.Allresponse = response.data;
                    ...
                    const entries = Object.values(this.Allresponse.data);
                        ...
                        this.$vs.notify({
                            text: "حصل خطأ يرجى اعادة المحاولة",
                            color: "danger",
                            fixed: true,
                            icon: "warning"
                        });
