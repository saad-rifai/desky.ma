<template>
    <div>
        ...
        <form v-if="new_request_is_allowed == true" class="mt-3" @submit.prevent>
            <div id="loadform_3"></div>

            <div class="mb-3">
                <label for="username" class="form-label"
                    >نوع وثيقة التعريف</label
                >
                <select
                ...
                <div
                    ...
                    v-if="errors.errors.document_type"
                >
            ...
            <div
                class="mb-3"
                v-if="file_type_name != '' && file_type_name != null"
            >
                ...
                <input
                    ...
                    class="form-control"
                    v-bind:class="{
                        'is-invalid': errors.errors.expiration_date
                    }"
            ...
            <div class="col w-100">
                <div
                    class="mb-3"
                    v-bind:hidden="
                        file_type_name == '' || file_type_name == null
                    "
                >
                    <label for="time" class="form-label">
                        ...
                        <i
                            ...
                            title="يجب أن تقوم بتحميل صورة واضحة للوثيقة التي اخترت أن تقوم بتوثيق حسابك بواسطتها (في حال اخترت بطاقة الهوية أو بطاقة الاقامة بجب تقديم صورة من الخلف وصورة من الوراء)"
                        ></i
                    ></label>
                    <div
          ...
          <div
            v-if="new_request_is_allowed == false && checkRequest.request.status == 0"
            ...
            <div class="col w-100">
                <div class="icon-large-top">
                    <img
                        ...
                        src="https://desky-ma-disk.s3.eu-west-3.amazonaws.com/assets/icons/pending.png"
                        alt="طلبك قيد المراجعة"
                    />
                </div>
            </div>
        ...
        <div v-if="new_request_is_allowed == false && checkRequest.request.status == 2"
        ...
        >
            <div class="col w-100">
                <div class="icon-large-top">
                    <img
                        style="max-width: 100px"
                        src="https://desky-ma-disk.s3.eu-west-3.amazonaws.com/assets/icons/forbidden.png"
                        alt="تم رفض طلبك"
                    />
                </div>
            </div>
            <div class="col w-100 mt-3">
                <p class="text-icon">
                    لقد تم حظرك من ارسال طلب توثيق حسابك 
                    <span class="d-block font-Naskh text-secondary">
                      {{checkRequest.request.message}}
                    </span>
                </p>
...
export default {
    ...
    methods: {
            ...
            for (var i = 0; count > i; i++) {
                if (file[i].size > 1024 * 1024) {
                    ...
                    this.$vs.notify({
                        ...
                        text:
                            "الحد الأقصى للملفات المسموح برفعها 2 اذا كنت تود تغيير الملفات المرجو حذف الملفات الموجودة حاليا *",
                        color: "danger",
                        position: "top-right",
                        icon: "error"
                    });
        ...
        CheckRequest() {
            axios
                .get("/ajax/user/documentation_center/check")
                .then(response => {
                    this.checkRequest = response.data;
