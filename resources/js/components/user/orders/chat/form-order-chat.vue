  ...
  <div class="position-relative">
    <div v-if="!chatbox" class="users-messages-menu">
      <div class="messages-menu-content">
        <vs-list>
            <div @click="users_menu_chat_click('/img/users/2021/8529090451-61a21c1dd5f5f.jpg')">
          <vs-list-item  title="Saad Rifai" subtitle="Top Contributor">
            ...
            <div @click="users_menu_chat_click('/img/users/2021/7684293048-619e582db97f0.jpg')">
          ...
          <div class="col-auto">
            <div>
              <button class="chat-btn">
                ...
                <span v-if="message == ''" class="material-icons-outlined"> mic </span>
                <span v-else data-testid="send" data-icon="send" class=""><svg viewBox="0 0 24 24" width="24" height="24" class=""><path fill="currentColor" d="M1.101 21.757L23.8 12.028 1.101 2.3l.011 7.912 13.623 1.816-13.623 1.817-.011 7.912z"></path></svg> </span>
              </button>
            </div>
          </div>
          <div class="col">
            <div><input dir="auto"  v-model="message" type="text" class="input-text-chat" /></div>
          </div>
