  ...
  <div>
    ...
    <div id="modal-share" uk-modal>
      <div dir="rtl" class="uk-modal-dialog uk-modal-body">
        ...
        <hr />
        <div
          v-if="privacy.length > 0 && privacy[0].public_facture == 0"
          class="uk-alert-primary"
          uk-alert
        >
          <p>
            انت لم تفعل خيار مشاركة الفواتير لن يتمكن أحد من غيرك مشاهدة
            الفواتير الخاصة بك من خلال الرابط المباشر
            <br />
            <br />
            ماذا أفعل ؟ يمكنك من خلال حسابي/
            <a href="#" class="uk-link">اعدادات الخصوصية</a>
            تفعيل خاصية مشاركة فاتورة عبر رابط مباشر
          </p>
        </div>
        <div
          class="uk-margin"
          v-if="privacy.length > 0 && privacy[0].public_facture == 1"
        >
          <a
    ...
    getDocumentStatus: function () {
      ...
      axios
        ...
        .then((response) => {
          ...
          this.share_link =
            window.location.href.replace('facture', 'print/facture') +
            '/' +
