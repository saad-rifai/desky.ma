...
@section('title', 'FACTURE-' . $infos->OID)
@section('content')
    <div class="wd-90 uk-margin ">
        ...
        <div class="uk-grid-small uk-child-width-1-2@s" uk-grid>
            ...
            <div class="uk-text-right">
                <ul class="uk-breadcrumb " dir="rtl">
                    ...
                    <li class="uk-disabled"><a>فاتورة #{{ $infos->OID }}</a></li>
        ...
        <div>
            ...
            <div class="uk-card uk-card-default uk-card-body">
                <facture-modifier-status :oid="'{{ $infos->OID }}'" :uid="'{{Auth::user()->id}}'"></facture-modifier-status>
                ...
                <div>
                    ...
                    <hr>
                    <facture-notes :oid="'{{$infos->OID}}'"></facture-notes>
