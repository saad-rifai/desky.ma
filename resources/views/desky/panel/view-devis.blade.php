    ...
    <div class="wd-90 uk-margin">
        ...
        <div>
            ...
            <div class="uk-card uk-card-default uk-card-body">
              <div class="uk-text-right" dir="rtl">
                <a target="_blank" href="{{ asset('print/devis/'.$infos->OID.'/'.Auth::user()->id) }}"> <button
                  type="button"
            ...
            <a target="_blank" href="{{ asset('print/devis/'.$infos->OID.'/'.Auth::user()->id) }}"> <button
              type="button"
              class="uk-button uk-button-danger uk-margin-top"
            >
              ...
              <div>
               ...
               $TotalFinal = ($subtotal-$tva_cost);
                ...
                <div class="item-border" id="fileds ">
                  <div
                    class="form-formulaire uk-text-center"
                    dir="rtl"
                    uk-grid
                  >
                    ...
                    <div class="uk-width-1-3@s">
                      <div class="uk-form-controls">
                        <label for="">الخدمة أو المنتج </label>
                        <br>
        ...
        @endphp
                ...
                <h1 class="uk-card-title uk-text-right">
                  ...
                  <hr>
                  <devis-modification :oid="'{{$infos->OID}}'" :status="{{ $infos->status }}"></devis-modification>
