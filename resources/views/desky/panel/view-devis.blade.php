    ...
    <div class="wd-90 uk-margin">
        ...
        <div>
            ...
            <div class="uk-card uk-card-default uk-card-body">
                <div hi class="uk-text-right" dir="rtl">
                    <button class="uk-dropdown-menu-orange"  type="button" dir="rtl"> اجرائات <span uk-icon="icon: triangle-down"></span></button>
<div uk-dropdown="mode: click; pos: bottom-right">
    <ul class="uk-nav uk-dropdown-nav">
        <li class="uk-active"><a target="_blank" href="{{ asset('print/devis/' . $infos->OID . '/' . Auth::user()->id) }}"><span uk-icon="icon:  file-pdf"></span> تصدير ملف PDF</a></li>
        <li class="uk-active"><a href="#"><span uk-icon="icon: link"></span>  تحويل الى فاتورة </a></li>
        <li class="uk-active"><a href="#"><span uk-icon="icon: file-edit"></span>  تعديل</a></li>
        <li class="uk-active"><a href="#"><span uk-icon="icon: trash"></span> حذف</a></li>

    </ul>
</div>
                <div hidden>
                    <div>
                        <a target="_blank" href="{{ asset('print/devis/' . $infos->OID . '/' . Auth::user()->id) }}">
                            <button type="button" class=" uk-button uk-button-primary uk-margin-top">

                                <span uk-icon="icon:  file-pdf"></span> تصدير PDF
                            </button>
                        </a>
                    </div>
                    <div>
                        <a target="_blank" href="{{ asset('print/devis/' . $infos->OID . '/' . Auth::user()->id) }}">
                            <button type="button" class=" uk-button uk-button-success uk-margin-top">
                                <span uk-icon="icon:  plus"></span> انشاء فاتورة
                            </button>
                        </a>
                    </div>
                ...
                <div>
                    ...
                    <div class="uk-margin uk-grid-small" uk-grid>
                        ...
                        <div class="uk-width-1-2@s" dir="rtl">
                            <label class="uk-text-right uk-text-muted uk-margin-left uk-margin" dir="rtl">شروط الدفع :</label>
                    ...
                    <hr>
                    <devis-modification :oid="'{{ $infos->OID }}'" :status="{{ $infos->status }}">
                    </devis-modification>
