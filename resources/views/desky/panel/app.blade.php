...
<body id="body">
    <div id="app">
            ...
            <div class="side-bar-content">
                <div class="uk-width-1-1@s uk-width-2-4@m">
                    ...
                    <ul class="uk-nav-default uk-nav-parent-icon " uk-nav>
                        <li class="uk-active"><a href="#"><i class="fas fa-tachometer-alt"></i> لوحة التحكم</a></li>
                        <li class="uk-active"><a href="#"> <i class="fas fa-envelope"></i>  الرسائل <span class="uk-badge">12</span>                        </a></li>
                        <li class="uk-parent">
                            <a href="#"><i class="fas fa-users"></i> العملاء</a>
                            <ul class="uk-nav-sub">
                                <li><a href="#"><i class="fas fa-list"></i> قائمة العملاء</a></li>
                                <li><a href="#"><i class="fas fa-plus"></i> اضافة عميل</a></li>

                            </ul>
                        </li>
                        <li class="uk-parent">
                            <a href="#"><i class="fas fa-file-invoice-dollar"></i> عروض الأسعار</a>
                            <ul class="uk-nav-sub">
                                <li><a href="#"><i class="fas fa-list"></i> قائمة عروض الأسعار</a></li>
                                <li><a href="#"><i class="fas fa-plus"></i> اضافة عرض أسعار</a></li>

                            </ul>
                        </li>
                        <li class="uk-parent">
                            <a href="#"><i class="fas fa-file-invoice"></i> الفواتير</a>
                            <ul class="uk-nav-sub">
                                <li><a href="#"><i class="fas fa-list"></i> قائمة الفواتير</a></li>
                                <li><a href="#"><i class="fas fa-plus"></i> اضافة فاتورة</a></li>

                            </ul>
                        </li>
                        <li class="uk-parent">
                            <a href="#"><i class="far fa-chart-bar"></i> التحليلات والتقارير</a>
                            <ul class="uk-nav-sub">
                                <li><a href="http://localhost/statistique/mois"><span></span>
                                        الاحصائيات و التقارير الشهرية</a></li>
                                <li dir="rtl"><a href="http://localhost/statistique/annee"><span></span>
                                        الاحصائيات التقارير السنوية </a></li>
                                <li dir="rtl"><a href="http://localhost/statistique/impot"><span></span>
                                        المحاسبة والضرائب </a></li>
                            </ul>
                        </li>
                        <li class="uk-parent">
                            <a href="#"><i class="fas fa-puzzle-piece"></i> الاضافات</a>
                            <ul class="uk-nav-sub">
                                <li><a href="#"><i class="fas fa-list"></i> قائمة العملاء</a></li>
                                <li><a href="#"><i class="fas fa-plus"></i> اضافة عميل</a></li>
                        ...
                        <li class="uk-parent">
                            <a href="#"><i class="fas fa-chart-network"></i> شبكة المقاولين الذاتيين</a>
                            <ul class="uk-nav-sub">
                                <li><a href="#"><i class="fas fa-list"></i> قائمة المقاولين</a></li>
                                <li><a href="#"><i class="fas fa-plus"></i> طلبات عروض</a></li>

                            </ul>
                        </li>
                        <li class="uk-parent">
                            <a href="#"><i class="fa fa-cog"></i> الاعدادات</a>
                            <ul class="uk-nav-sub">
                                <li><a href="#"><i class="fas fa-list"></i> قائمة العملاء</a></li>
                                <li><a href="#"><i class="fas fa-plus"></i> اضافة عميل</a></li>
        ...
        <div>
            ...
            <div class="h-85"></div>
            <!-- Header Of Website -->
            <nav class="uk-navbar-container Blue-brand-ayol "  dir="rtl" uk-navbar>

                <div class="center-ayol">

                    <div class="uk-navbar-right" style=" margin-right: 0 !important;">
                        <button onclick="toggel_side_bar()" id="side-bar-toggel" type="button"
                            class="toggel-button"><span uk-icon="icon: menu; ratio: 2"></span></button>
                        <input type="checkbox" value="show" id="toggel-check" checked hidden>
                    ...
                    @else
                        ...
                        <div uk-dropdown="boundary: .boundary">
                            <ul dir="rtl" class="uk-nav uk-dropdown-nav uk-text-right">
                                <li class="l1"><a href="{{ asset('u/account') }}"><span uk-icon="user"></span> حسابي </a>
                                </li>
                                <li class="l2"><a href="{{ asset('u/abonnement') }}"><span uk-icon="credit-card"></span>
                                        الاشتراكات والدفع</a></li>
                                <li class="l3"><a href="{{ asset('u/settings') }}"><span uk-icon="file-edit"></span>
                                        اعدادات الحساب </a></li>
                                <li class="l4"><a href="{{ asset('desk/settings') }}"><span uk-icon="settings"></span>
                                        اعدادات المكتب</a></li>
                                <li class="l5"><a href="{{ asset('u/privacy') }}"><span uk-icon="lock"></span> اعدادات
                                        الخصوصية</a></li>
                                <li class="l6"><a href="/u/payments/history"><span uk-icon="history"></span> سجل
                                        المدفوعات</a></li>
            ...
            @auth
                ...
                @if ($c_products < 1)
                    <div class="alert-f-w warning">
                        <p dir="rtl"><span uk-icon="icon: warning"></span> لقد نفد رصيدك يرجى <a href="/register/pack">تجديد
                                اشتراكك</a>
                        </p>
                    </div>
                @endif
                ...
                <div id="copyright">
                    <div class="container" style="width: auto !important;">
                        ...
                        <p dir="rtl">
                            ...
                            <br>
                            <small>v {{ env('APP_VERSION') }} ({{ env('APP_RELEASE_YEAR') }}) @if (env('APP_BETA') == true) BETA @endif
                            </small>
                        </p>
