                    ...
                    <div class="uk-navbar-right">
                        ...
                        <div class="uk-navbar-center">
                            ...
                            <ul class="uk-navbar-nav">
                                <li> <a href="{{ URL::asset('/u') }}" class="uk-button-text"><i class="fas fa-tachometer-alt"></i> &nbsp; لوحة التحكم</a>
                                </li>
                                <li>
                                    ...
                                    <div uk-dropdown="animation: uk-animation-slide-top-small; duration: 1000; pos: bottom-right"
                                        class="">
                                                ...
                                                <ul class="uk-nav uk-dropdown-nav">
                                                    ...
                                                    <li><a href="{{ URL::asset('/service/je-veux-devenir-auto-entrepreneur') }}"><i class="fas fa-plus"></i>
                                                            انشاء عميل</a></li>
                            ...
                            <ul class="uk-navbar-nav">
                                <li>
                                    <a href="{{ URL::asset('/#services') }}" class="uk-button-text"><i class="fas fa-file-invoice-dollar"></i> &nbsp; عروض الاسعار
                                        </a>
                                        ...
                                        <div class="uk-navbar-dropdown-grid">
                                            ...
                                            <div>
                                                <ul class="uk-nav uk-navbar-dropdown-nav">
                                                    ...
                                                    <li><a href="{{ URL::asset('/creer/devis') }}"><i class="fas fa-plus"></i>
                                                            انشاء عرض اسعار</a>
                                                    </li>
                                                    <li dir="rtl"><a
                                                            href="{{ URL::asset('/devis/list') }}"><i class="fas fa-list"></i>
                            ...
                            <ul class="uk-navbar-nav">
                                <li>
                                    <a href="{{ URL::asset('/#services') }}" class="uk-button-text"><i class="fas fa-file-invoice"></i> &nbsp; الفواتير</a>
                                    <div uk-dropdown="animation: uk-animation-slide-top-small; duration: 1000"
                                        class="uk-navbar-dropdown uk-navbar-dropdown-width-1">
                                        <div class="uk-navbar-dropdown-grid">
                                            ...
                                            <div>
                                                <ul class="uk-nav uk-navbar-dropdown-nav">
                                                    ...
                                                    <li><a href="{{ URL::asset('/service/etude-de-project') }}"><i class="fas fa-plus"></i>
                                                            انشاء فاتورة</a>
                                                    </li>
                                                    <li dir="rtl"><a
                                                            href="{{ URL::asset('/service/je-veux-devenir-auto-entrepreneur') }}"><i class="fas fa-list"></i>
                                                            قائمة الفواتير</a></li>
                            ...
                            <ul class="uk-navbar-nav">
                                <li>
                                    <a href="{{ URL::asset('/#services') }}" class="uk-button-text"><i class="far fa-chart-bar"></i> &nbsp; التحليلات والأدوات</a>
                                    <div uk-dropdown="animation: uk-animation-slide-top-small; duration: 1000"
                                        class="uk-navbar-dropdown uk-navbar-dropdown-width-1">
                                        <div class="uk-navbar-dropdown-grid">
                            ...
                            <ul class="uk-navbar-nav">
                                <li>
                                    <a href="{{ URL::asset('/#services') }}" class="uk-button-text"><i class="fas fa-cog"></i> &nbsp; الاعدادات</a>
                                    <div uk-dropdown="animation: uk-animation-slide-top-small; duration: 1000"
                                        class="uk-navbar-dropdown uk-navbar-dropdown-width-1">
                                        <div class="uk-navbar-dropdown-grid">
                    ...
                    @else
                        ...
                        <div uk-dropdown="boundary: .boundary">
                            <ul dir="rtl" class="uk-nav uk-dropdown-nav uk-text-right">
                                <li><a href="{{ asset('u') }}"><span uk-icon="user"></span> حسابي </a></li>
