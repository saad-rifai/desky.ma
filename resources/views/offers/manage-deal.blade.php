    ...
    <div class="container mt-5 mb-5">
        <div class="row text-center" dir="rtl">
            ...
            <div class="col-sm-auto mt-3" align="right">
                <div class="dropdown">
                    <button class="btn btn-primary btn-sm dropdown-toggle" type="button" id="{{$data->OID}}" data-toggle="dropdown" aria-expanded="false">
                    الاجرائات <i class="fas fa-caret-down"></i>
                    </button>
                    <ul class="dropdown-menu" aria-labelledby="{{$data->OID}}">
                      <li><a class="dropdown-item" href="#"><i class="fas fa-truck"></i> تسليم الطلب</a></li>
                      <li><a class="dropdown-item" href="#"> <i class="fas fa-flag"></i> تبليغ</a></li>
                    </ul>
                  </div>
                    ...
                    <div class="body-card-text">
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane  fade position-relative" id="messages" role="tabpanel"
                                ...
                                <!-- Chat Box -->
                                <deal-messages oid="{{$data->OID}}" account_number="{{Auth::user()->Account_number}}"></deal-messages>
                                <!-- Chat Box -->
