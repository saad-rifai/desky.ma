...
<head>
    <title>تحديث بخصوص طلب تفعيل حساب المقاول الذاتي - Desky.ma</title>
...
">
        ...
        ">
                ...
                يسعدنا أن نعلمك أنه قد تمت الموافقة على طلبك لتفعيل حساب المقاول الذاتي أصبح الأن بامكانك تقديم عروضك
                على الطلبات وتلقي الرسائل من العملاء
                <br>
                <br>
                <a href="{{ asset('orders?ref=email_notification') }}" target="_blank" style="
                padding: 10px 25px;
