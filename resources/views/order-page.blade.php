...
@section('content')
    ...
    <div class="container mb-5 mt-2">
        ...
        <div class="box-left  card p-4 mt-4">
            ...
            <div class="mt-2">
                <input type="text" onclick="this.setSelectionRange(0, this.value.length)" style="cursor: pointer;" readonly="readonly" class="form-control text-center" name="" value="https://desky.ma/order/854726"
                    id="">
