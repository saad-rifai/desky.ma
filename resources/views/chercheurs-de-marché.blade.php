@section('title', 'chercheurs de marché')
    ...
    <header class="header-bg-2">
        <nav class="navbar navbar-expand-lg f1-head-nav fixed-top navbar-transparent">
            <div class="container">
                ...
                <a class="navbar-brand" href="#"><img class="transparent-nav-logo"
                        src="{{asset('img/logo-web-white.png')}}" alt="logo desky"></a>
                <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-5">
                        <li class="nav-item">
                            <a class="nav-link  effect-line" aria-current="page" href="{{asset('/')}}">Accueil</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link effect-line active" href="{{asset('chercheurs-de-marché')}}">Chercheurs de marché</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="row h-700 text-center mx-auto mt-5 row-cols-1 row-cols-sm-1 row-cols-md-2 align-items-center">
                ...
                <div class="col align-self-center">
                    <div class="video-thumb position-relative">
                        ...
                        <img src="{{asset('img/vid-2.jpg')}}" alt="">
    ...
    <div class="rows-container">
        ...
        <div class="container">
            <div class="row h-700 text-center mx-auto  row-cols-1 row-cols-sm-1 row-cols-md-2 align-items-center">
                <div class="col align-self-center">
                    <div class="video-thumb position-relative">
                        <img src="{{asset('img/assets/4.jpg')}}" alt="">
                    </div>
                </div>
                <div class="col align-self-center ">
                    <div class=" text-start">
                        ...
                        <p class="">Le Lorem Ipsum est simplement du faux texte employé dans la composition et la mise
                            en page avant
            ...
            <div dir="rtl"
                class="row h-700 text-center mx-auto  row-cols-1 row-cols-sm-1 row-cols-md-2 align-items-center">
                <div class="col align-self-center">
                    <div class="video-thumb position-relative">
                        <img src="{{asset('img/assets/5.jpg')}}" alt="">
                    </div>
                </div>
                <div class="col align-self-center ">
                    <div class=" text-start">
                        <h1 class="">
                            postuler sur les appelle d'offre ouvertes
                        </h1>
                        <p class="">Le Lorem Ipsum est simplement du faux texte employé dans la composition et la mise en page avant impression. Le Lorem Ipsum est le faux texte standard de l'imprimerie depuis les années 1500</p>
            ...
            <div class="row h-700 text-center mx-auto  row-cols-1 row-cols-sm-1 row-cols-md-2 align-items-center">
                ...
                <div class="col align-self-center">
                    <div class="video-thumb position-relative">
                        ...
                        <img src="{{asset('img/assets/6.jpg')}}" alt="">
                    </div>
                </div>
                <div class="col align-self-center ">
                    <div class=" text-start">
                        <h1 class="">
                            attente de l'annonce des résultats
                        </h1>
                        <p class="">Le Lorem Ipsum est simplement du faux texte employé dans la composition et la mise
                            en page avant
                            impression. Le Lorem Ipsum est le faux texte standard de l'imprimerie depuis les années 1500
...
<div class="container">
    <h1 class="page-title text-center">les tarif</h1>
    <div class="tarif-section">
        <div class="container">
            <div class="tarif-switch-box">
                <button class="switch-button">annuel</button>
                <button class="switch-button active">Mensuel</button>
            </div>
        </div>
    </div>
    <div class="pack-sections">
        <div class="row justify-content-md-center text-center mt-5 mb-5 row-cols-1 row-cols-sm-2 row-cols-md-4">
            <div class="col">
                <div class="pack-box">
                    <div class="pack-head">
                        <h2 class="pack-title">Pack Gratuit</h2>
                        <h1 class="pack-price">
                            0 MAD <span class="price-mois">/ Mois</span>
                        </h1>
                    </div>
                    <div class="pack-body">
                        <ul class="pack-content-list">
                            <li><i class="fas fa-check"></i> Soumettre une offre  sur une 3 appel d'offre</li>
                            <li><i class="fas fa-check"></i> Apparaître dans les moteurs de recherche</li>
                            <li><i class="fas fa-times"></i> portfolio</li>
                        </ul>
                    </div>
            ...
            <div class="col">
                <div class="pack-box position-relative">
                    <span class="badge-pack">POPULAIRE</span>
                    <div class="pack-head">
                        <h2 class="pack-title">Pack Economy</h2>
                        <h1 class="pack-price">
                            59 MAD <span class="price-mois">/ Mois</span>
                        </h1>
                    </div>
                    <div class="pack-body">
                        <ul class="pack-content-list">
            ...
            <div class="col">
                <div class="pack-box">
                    <div class="pack-head">
                        <h2 class="pack-title">Pack Deluxe</h2>
                        <h1 class="pack-price">
                            249 MAD <span class="price-mois">/ Mois</span>
                        </h1>
                    </div>
                    <div class="pack-body">
                        <ul class="pack-content-list">
            ...
            <div class="col">
                <div class="pack-box">
                    <div class="pack-head">
                        <h2 class="pack-title">Pack illimité </h2>
                        <h1 class="pack-price">
                            999 MAD <span class="price-mois">/ Mois</span>
                        </h1>
                    </div>
                    <div class="pack-body">
                        <ul class="pack-content-list">
    ...
    <div class="banner-orange mt-5">
        <div class="container">
            <div class="row align-items-center justify-content-md-center text-center">
                ...
                <div class="col-md-auto"><button type="button" class="btn btn-outline-primary">Contactez nos
                        conseillers</button></div>
            </div>
        </div>
    </div>
