...
<head>
    ...
    <title>desky - تأكيد البريد الالكتروني</title>
    <!-- Font-awsome -->
    ...
    <div class="container">
        ...
        <div class="card p-3 mt-3 mb-5 mx-auto" style="max-width: 750px" dir="rtl">
            <div class="content-form p-3 pt-1">
                <h1 class="card-title mb-4 mt-3"> تأكيد البريد الالكتروني</h1>
                ...
                <div class="alert alert-success text-center" role="alert">
                   ...
                   <br>
                   <br>
                     <a href="{{route('login')}}"><button type="button" class="btn btn-success">  حسابي</button></a>
                    </div>
                  </div>
        ...
        <div class="card p-3 mt-3 mb-5 mx-auto" style="max-width: 750px" dir="rtl">
            <div class="content-form p-3 mx-auto" >
                <span class="text-center"> <a href="{{ asset('login') }}">سجل الدخول</a></span>
            </div>
        </div>
    </div>
